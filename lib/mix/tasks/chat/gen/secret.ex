defmodule Mix.Tasks.Chat.Gen.Secret do
  @shortdoc "Generates a secret"

  @moduledoc """
  Generates a secret and prints it to the terminal.
      $ mix chat.gen.secret [length]
  By default, mix chat.gen.secret generates a key 64 characters long.
  The minimum value for `length` is 32.

  Shamelessly copied from Phoenix's [phx.gen.secret](https://github.com/phoenixframework/phoenix/blob/a2e4b1a9f33d71c6c53ca78e2dfdfcba26c12503/lib/mix/tasks/phx.gen.secret.ex#L1)
  """
  use Mix.Task
  ...
  defp invalid_args! do
    Mix.raise "mix chat.gen.secret expects a length as integer or no argument at all"
  end
end
